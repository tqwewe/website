...
<ul>
<li>
<p>To your repo <code>CHANGELOG.md</code> file with <code>cog bump</code> (see: <RouterLink to="/user_guide/docs/user_guide/versioning.mdde/versioning.html#auto-bump">auto bump</RouterLink>)</p>
</li>
<li>
